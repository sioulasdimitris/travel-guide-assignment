            ...
            <div class="btn-group" data-toggle="buttons">
                <label class="btn btn-secondary {{isActive($place->booking_type, \App\Models\Booking::TYPE_BOOKING_FORM)}}" data-toggle-class="btn-default" data-toggle-passive-class="btn-default">
                    <input type="radio" class="join-btn" name="booking_type"
                           value="{{\App\Models\Booking::TYPE_BOOKING_FORM}}" {{isChecked($place->booking_type, \App\Models\Booking::TYPE_BOOKING_FORM)}}>Booking Form
                </label>
                <label class="btn btn-secondary {{isActive($place->booking_type, \App\Models\Booking::TYPE_CONTACT_FORM)}}" data-toggle-class="btn-default" data-toggle-passive-class="btn-default">
                    <input type="radio" class="join-btn" name="booking_type"
                           value="{{\App\Models\Booking::TYPE_CONTACT_FORM}}" {{isChecked($place->booking_type, \App\Models\Booking::TYPE_CONTACT_FORM)}}>Contact Form
                </label>
                <label class="btn btn-secondary {{isActive($place->booking_type, \App\Models\Booking::TYPE_AFFILIATE)}}" data-toggle-class="btn-default" data-toggle-passive-class="btn-default">
                    <input type="radio" class="join-btn" name="booking_type"
                           value="{{\App\Models\Booking::TYPE_AFFILIATE}}" {{isChecked($place->booking_type, \App\Models\Booking::TYPE_AFFILIATE)}}>Booking Affiliate Link
                </label>
                <label class="btn btn-secondary {{isActive($place->booking_type, \App\Models\Booking::TYPE_BANNER)}}" data-toggle-class="btn-default" data-toggle-passive-class="btn-default">
                    <input type="radio" name="booking_type" value="{{\App\Models\Booking::TYPE_BANNER}}"
                           class="join-btn" {{isChecked($place->booking_type, \App\Models\Booking::TYPE_BANNER)}}>Banner Link
                </label>
                <label class="btn btn-secondary {{isActive($place->booking_type, \App\Models\Booking::TYPE_MAP)}}" data-toggle-class="btn-default" data-toggle-passive-class="btn-default">
                    <input type="radio" name="booking_type" value="{{\App\Models\Booking::TYPE_MAP}}"
                           class="join-btn" {{isChecked($place->booking_type, \App\Models\Booking::TYPE_MAP)}}>Maps
                </label>
            </div>
