                            ...
                            @foreach($testimonials as $testimonial)
                                <tr class="even pointer">
                                    ...
                                    <td>
                                        ...
                                        <form class="d-inline" action="{{route('admin_testimonial_destroy', $testimonial['id'])}}" method="POST">
                                            @method('DELETE')
                                            @csrf
                                            <button type="button" class="btn btn-danger btn-xs city_delete" onclick="if(confirm('Are you sure? The ttestimonial that deleted can not restore!')) $(this).parent().submit();">Delete</button>
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
